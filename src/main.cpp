...
/*i2c adresses
   ...
   EEPROM        0x50 DEC:80
 */
#define PHaddress 100               //default I2C ID number for EZO pH Circuit.
...
///Print legend to file
                ...
                Serial.print("Cant open datafile");
                while (1==1) {
                        LED(255,0,0);
                        delay(200);
                        LED(0,0,0);
...
void logging(){
        ...
        digitalWrite(lineDrvOn, LOW);
        Serial.println(F("digitalWrite(lineDrvOn, LOW);"));
        ...
        Serial.println(F("digitalWrite(lineDrvOn, HIGH);"));
